...
export function TryDiannCta() {
  return (
    <div className="w-full  bg-[#080808] flex items-center justify-center p-8 pb-16 border-b border-[#212121]">
      <div className="w-full max-w-5xl aspect-[20/8] bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg flex items-center justify-center ">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl lg:text-[64px] font-regular mb-8 leading-tight text-white">
